...
export const Categories = () => {
  ...
  const MOCK_PRODUCTS = useMemo<Product[]>(() => [
    ...
    { id: '9', name: 'Corporate Executive Set', description: 'Premium pen and notebook set for professionals.', price: 120.00, image: 'https://images.unsplash.com/photo-1586075010633-2442dc3d6307?auto=format&fit=crop&q=80&w=800', category: 'Corporate', rating: 4.9 },
    { id: '10', name: 'Customized Desk Organizer', description: 'Keep your workspace tidy and stylish.', price: 45.00, image: 'https://images.unsplash.com/photo-1591123120675-6f7f1aae0e5b?auto=format&fit=crop&q=80&w=800', category: 'Corporate', rating: 4.7 },
    { id: '11', name: 'Premium Coffee Mug Set', description: 'Set of 4 artisanal ceramic mugs.', price: 55.00, image: 'https://images.unsplash.com/photo-1514228742587-6b1558fcca3d?auto=format&fit=crop&q=80&w=800', category: 'Home Decor', rating: 4.6 },
    { id: '12', name: 'Wireless Charging Pad', description: 'Sleek wood-finish charging station.', price: 39.99, image: 'https://images.unsplash.com/photo-1586816832767-da2466088094?auto=format&fit=crop&q=80&w=800', category: 'Corporate', rating: 4.8 },
    { id: '13', name: 'Leather Laptop Sleeve', description: 'Handcrafted protection for your device.', price: 65.00, image: 'https://images.unsplash.com/photo-1544816155-12df9643f363?auto=format&fit=crop&q=80&w=800', category: 'Corporate', rating: 4.7 },
    { id: '14', name: 'Artisanal Tea Collection', description: 'Selection of rare loose-leaf teas.', price: 42.00, image: 'https://images.unsplash.com/photo-1594631252845-29fc4cc8cde9?auto=format&fit=crop&q=80&w=800', category: 'Personalized', rating: 4.9 },
    { id: '15', name: 'Modern Wall Clock', description: 'Minimalist design for contemporary homes.', price: 75.00, image: 'https://images.unsplash.com/photo-1563861826100-9cb868fdbe1c?auto=format&fit=crop&q=80&w=800', category: 'Home Decor', rating: 4.5 },
  ], []);
  ...
  const filteredProducts = useMemo(() => {
    return MOCK_PRODUCTS.filter(p => {
      ...
      const occasionMatch = selectedOccasions.length === 0 || selectedOccasions.includes(p.category);
      const ratingMatch = selectedRating === null || (p.rating || 0) >= selectedRating;
      
      return categoryMatch && priceMatch && occasionMatch && ratingMatch;
    });
  }, [selectedCategory, priceRange, selectedOccasions, selectedRating, MOCK_PRODUCTS]);
