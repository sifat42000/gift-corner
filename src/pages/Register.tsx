    ...
    <div className="mx-auto max-w-md px-4 py-20">
      ...
      >
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-stone-500">Join Gift Corner today</p>
        </div>

        {error && (
          <div className="mb-6 flex items-center gap-2 rounded-xl bg-rose-50 p-4 text-sm text-rose-600">
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold uppercase tracking-widest text-stone-400">Confirm Password</label>
            <div className="relative">
              <Lock className="absolute left-4 top-1/2 h-4 w-4 -translate-y-1/2 text-stone-400" />
              <input 
                required
          ...
          <button 
            type="submit"
            disabled={loading}
            className="w-full rounded-2xl bg-emerald-600 py-4 text-sm font-bold text-white shadow-lg shadow-emerald-200 transition-all hover:bg-emerald-700 hover:shadow-none disabled:opacity-50"
          >
        ...
        <button 
          ...
          className="flex w-full items-center justify-center gap-3 rounded-2xl border border-stone-200 py-4 text-sm font-bold text-stone-700 transition-all hover:bg-stone-50"
        >
